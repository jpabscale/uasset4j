...
// Source: UAssetAPI/UAssetAPI/PropertyTypes/Objects/UInt32PropertyData.cs
...
class UInt32PropertyData : PropertyData {
    ...
    override fun CreateClone(): PropertyData = UInt32PropertyData()

    constructor(name: FName?) : super(name)
    constructor() : super()

    companion object {
        private val CurrentPropertyType = FString("UInt32Property")
    }
}
