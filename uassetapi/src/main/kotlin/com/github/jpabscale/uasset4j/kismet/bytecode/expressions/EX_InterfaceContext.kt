...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_InterfaceContext.cs
...
class EX_InterfaceContext : KismetExpression() {
    override val Token: EExprToken get() = EExprToken.EX_InterfaceContext

    var InterfaceValue: KismetExpression? = null
