...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_UInt64Const.cs
...
class EX_UInt64Const : KismetExpressionGeneric<Long>() {
    override val Token: EExprToken get() = EExprToken.EX_UInt64Const
    ...
    override fun Visit(asset: UAsset, offset: Ref<Long>, visitor: (KismetExpression, Long) -> Unit) {
        ...
        offset.value = offset.value!! + 8 // Value
    }
}
