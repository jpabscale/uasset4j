...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_ClearMulticastDelegate.cs
...
class EX_ClearMulticastDelegate : KismetExpression() {
    override val Token: EExprToken get() = EExprToken.EX_ClearMulticastDelegate

    var DelegateToClear: KismetExpression? = null
