...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_ComputedJump.cs
...
class EX_ComputedJump : KismetExpression() {
    override val Token: EExprToken get() = EExprToken.EX_ComputedJump

    var CodeOffsetExpression: KismetExpression? = null
    ...
    override fun Visit(asset: UAsset, offset: Ref<Long>, visitor: (KismetExpression, Long) -> Unit) {
        ...
        CodeOffsetExpression!!.Visit(asset, offset, visitor)
    }
}
