...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_UnicodeStringConst.cs
...
class EX_UnicodeStringConst : KismetExpressionGeneric<String>() {
    override val Token: EExprToken get() = EExprToken.EX_UnicodeStringConst
    ...
    override fun Visit(asset: UAsset, offset: Ref<Long>, visitor: (KismetExpression, Long) -> Unit) {
        ...
        offset.value = offset.value!! + 2 * (Value.length + 1) // Unicode string + null terminator (2 bytes per char)
    }
}
