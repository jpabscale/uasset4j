...
// Source: UAssetAPI/UAssetAPI/Kismet/Bytecode/Expressions/EX_Return.cs
...
class EX_Return : KismetExpression() {
    override val Token: EExprToken get() = EExprToken.EX_Return

    /** The return expression. */
    var ReturnExpression: KismetExpression? = null
    ...
    override fun Visit(asset: UAsset, offset: Ref<Long>, visitor: (KismetExpression, Long) -> Unit) {
        ...
        ReturnExpression!!.Visit(asset, offset, visitor)
    }
}
